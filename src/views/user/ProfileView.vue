...
const profileImageUrl = ref('https://tse4.mm.bing.net/th?id=OIP.ey0rShaVNsv2AbYkoZlvcwAAAA&pid=Api&P=0&h=180')
const email = ref('')
const name = ref('')
const tel = ref('')
      ...
      <div class="font-bold text-2xl text-center">Profile</div>
        ...
        <div class="flex flex-col items-center">
          ...
          <div class="form-control w-full">
            ...
            <input v-model="tel" type="text" placeholder="Type here" class="input input-bordered w-full"/>
          </div>
          <div class="form-control w-full">
            <label class="label">
